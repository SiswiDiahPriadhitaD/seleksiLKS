		...
		<div class="berita">
			...
			?>
				<div class="box">
					...
					<a href="formlogin.php" onclick="return confirm('Anda harus login!!')">Baca Selengkapnya</a>
				</div>
			<?php
				}
 			?>
	...
	<footer>
		<div class="head">
			...
			<div class="head-right">
				<a onclick="return confirm('Maaf anda harus Login terlebih dahulu')" href="formlogin.php">coment</a>
			</div>
		</div>
		<div class="body">
			<div class="box">
